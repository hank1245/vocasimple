...
const FlashcardScreenImpl = () => {
  ...
  const fetchVocabularyWords = useCallback(async () => {
    ...
    try {
      ...
      Alert.alert("Error", "An error occurred while creating flashcards.", [
        { text: "OK", onPress: () => router.back() },
      ]);
    } finally {
      setIsLoading(false);
    }
  }, [vocabularyData, router, progress, user, isGuest]);
    ...
    return (
      <SafeAreaView style={styles.container}>
        <View style={styles.loadingContainer}>
          <AppText style={styles.loadingText} text="Preparing flashcards..." />
        </View>
      </SafeAreaView>
    );
  }
...
const styles = StyleSheet.create({
  ...
  cardCounter: { textAlign: "center", fontSize: 16, color: "#666" },
  cardContainer: {
    flex: 1,
  ...
  navButtonDisabled: { backgroundColor: "#f5f5f5" },
  ...
  actionButtonText: { fontSize: 12, color: Colors.primary, marginTop: 5 },
  completeContainer: { paddingHorizontal: 20, paddingBottom: 20 },
  completeButton: {
    backgroundColor: Colors.primary,
    paddingVertical: 15,
    borderRadius: 10,
  ...
  completeButtonText: { color: "white", fontSize: 18, fontWeight: "bold" },
  loadingContainer: { flex: 1, justifyContent: "center", alignItems: "center" },
  loadingText: { fontSize: 18, color: "#666" },
});

export default FlashcardScreenImpl;
